...
def process_paysim_dataframe(df):
    ...
    if target_col not in df.columns:
        raise ValueError("Target column 'isFraud' or 'is_fraud' missing from DataFrame.")
...
def load_and_partition_paysim(csv_path=None, output_dir="data/banks"):
    """Loads PaySim1 CSV file, processes features, and splits into data/banks/bank_N.csv files."""
    ...
    for i in range(4):
        ...
        bank_sub.to_csv(os.path.join("data", f"bank_{i}.csv"), index=False)
