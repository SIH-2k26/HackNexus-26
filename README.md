...
git clone https://github.com/SarthakPatil18/Vaultic-API.git
cd Vaultic-API
...
# Generate initial bank datasets (Bank 0 - 3)
...
cd artifacts/fraud-detection-dashboard
...
3. Add Environment Variables:
   ...
   - `FRAUD_API_KEY`: `vlt_op_9e8d4a72f1b03c8e5d2a6b4c1f7e9a0d` *(or generate a custom master key)*
...
2. Set **Root Directory**: `artifacts/fraud-detection-dashboard` *(or root, supported by root `vercel.json`)*.
3. Configure Environment Variables:
   - `VITE_API_BASE_URL`: `https://your-backend-app.onrender.com`
   - `VITE_OPERATOR_API_KEY`: `vlt_op_9e8d4a72f1b03c8e5d2a6b4c1f7e9a0d`
   - `VITE_SUPABASE_URL`: `https://hwtijowpftqjscwuzmvo.supabase.co`
